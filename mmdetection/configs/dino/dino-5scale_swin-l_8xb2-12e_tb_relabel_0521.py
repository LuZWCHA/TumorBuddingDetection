_base_ = './dino-4scale_r50_8xb2-12e_tb_relabel_0521.py'

pretrained = 'https://github.com/SwinTransformer/storage/releases/download/v1.0.0/swin_large_patch4_window12_384_22k.pth'  # noqa
load_from = '/nasdata2/private/zwlu/detection/TumorBuddingDetection/mmdetection/work_dirs/dino-5scale_swin-l_8xb2-12e_tb/epoch_4.pth'
num_levels = 5
model = dict(
