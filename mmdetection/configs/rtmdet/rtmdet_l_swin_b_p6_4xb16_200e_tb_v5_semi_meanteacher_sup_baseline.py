_base_ = './rtmdet_l_swin_b_4xb32-100e_tb_relabel_0819.py'
...
work_dir = f"./work_dirs/rtmdet_l_swin_b_p6_4xb16_200e_tb_v5_semi_meanteacher_sup_baseline_p_{labeled_percent}"