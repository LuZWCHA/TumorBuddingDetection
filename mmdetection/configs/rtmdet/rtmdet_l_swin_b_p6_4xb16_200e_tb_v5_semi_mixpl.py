_base_ = [
    './rtmdet_l_swin_b_p6_4xb16-100e_tb_relabel_0819_finetune_no_cp.py',
    './mixpl_tb_detection_v5.py'
]
...
work_dir = f'./work_dirs/rtmdet_l_swin_b_p6_4xb16_{max_iter}i_tb_v5_semi_mixpl_p_{labeled_precent}_finetune'
