...
from mmdetection.mmdet.models.dense_heads.rtmdet_head import RTMDetHead, RTMDetSepBNHead
from mmdetection.mmdet.models.dense_heads.rtmdet_ins_head import RTMDetInsHead
from mmdetection.mmdet.models.detectors.rtmdet import RTMDet
from .base import BaseDetector


@MODELS.register_module()
class SemiSoftTeaDetector(BaseDetector):
    ...
    def get_pseudo_instances(
        ...
        self.teacher: RTMDet
        # self.teacher.bbox_head: RTMDetSepBNHead
        # tuple(cls_scores), tuple(bbox_preds)
        cls_scores_list, bbox_preds_list = self.teacher.bbox_head(x)
